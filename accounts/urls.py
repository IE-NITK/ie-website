...
urlpatterns = [
  ...
  path('rahulandchaitany/round-1',views_profile.test_round_1,name='round_1_test'),
  path('profile/test/round-1/update_counter', views_profile.update_esc_counter, name = 'update_esc_counter')
